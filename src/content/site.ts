...
export const channels: Channel[] = [
  {
    ...
    qrImage: "",
    language: "English",
    editorialPromise: "Long-form essays on design systems and evidence.",
    cadence: "Monthly",
    latestItem: "",
    enabled: false,
  },
  {
    ...
    qrImage: "",
    language: "English",
    editorialPromise: "Cross-posted engineering and product notes.",
    cadence: "Occasional",
    latestItem: "",
    enabled: false,
  },
